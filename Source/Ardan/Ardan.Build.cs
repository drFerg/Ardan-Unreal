...
public class Ardan : ModuleRules
{
	public Ardan(TargetInfo Target)
	{
        ...
        PublicAdditionalLibraries.Add("E:/Unreal/Project/Ardan/packages/librdkafka.redist.0.11.3/build/native/lib/win7/x64/win7-x64-Release/v120/librdkafka.lib");
        PublicAdditionalLibraries.Add("E:/Unreal/Project/Ardan/packages/librdkafka.redist.0.11.3/build/native/lib/win7/x64/win7-x64-Release/v120/librdkafkacpp.lib");

        PublicIncludePaths.Add("E:/Unreal/Project/Ardan/packages/librdkafka.redist.0.11.3/build/native/include");
