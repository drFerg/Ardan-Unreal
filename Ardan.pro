...
unrealRootPath=/home/fwl14/projects/UnrealEngineGit
ArdanRootPath=/home/fwl14/Documents/Unreal Projects/Ardan

gameProjectFile=/home/fwl14/Documents/Unreal Projects/Ardan/Ardan.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(ArdanSource.pri)
include(ArdanHeader.pri)
include(ArdanConfig.pri)
include(ArdanIncludes.pri)
include(ArdanDefines.pri)
...
Ardan-Linux-Debug.commands = $$build Ardan Linux Debug  -project="\"$$gameProjectFile\"" $$args
Ardan-Linux-DebugGame.commands = $$build Ardan Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Ardan-Linux-Shipping.commands = $$build Ardan Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Ardan-Linux-Test.commands = $$build Ardan Linux Test  -project="\"$$gameProjectFile\"" $$args
Ardan.commands = $$build Ardan Linux Development  -project="\"$$gameProjectFile\"" $$args

ArdanEditor-Linux-Debug.commands = $$build ArdanEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
ArdanEditor-Linux-DebugGame.commands = $$build ArdanEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ArdanEditor-Linux-Shipping.commands = $$build ArdanEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ArdanEditor-Linux-Test.commands = $$build ArdanEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
ArdanEditor.commands = $$build ArdanEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Ardan-Linux-Debug \
	Ardan-Linux-DebugGame \
	Ardan-Linux-Shipping \
	Ardan-Linux-Test \
	Ardan \
	ArdanEditor-Linux-Debug \
	ArdanEditor-Linux-DebugGame \
	ArdanEditor-Linux-Shipping \
	ArdanEditor-Linux-Test \
	ArdanEditor \
