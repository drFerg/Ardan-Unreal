...
Ardan-Linux-Debug:
	 $(PROJECTBUILD) Ardan Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Ardan-Linux-DebugGame:
	 $(PROJECTBUILD) Ardan Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Ardan-Linux-Shipping:
	 $(PROJECTBUILD) Ardan Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Ardan-Linux-Test:
	 $(PROJECTBUILD) Ardan Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Ardan:
	 $(PROJECTBUILD) Ardan Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArdanEditor-Linux-Debug:
	 $(PROJECTBUILD) ArdanEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArdanEditor-Linux-DebugGame:
	 $(PROJECTBUILD) ArdanEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArdanEditor-Linux-Shipping:
	 $(PROJECTBUILD) ArdanEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArdanEditor-Linux-Test:
	 $(PROJECTBUILD) ArdanEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArdanEditor:
	 $(PROJECTBUILD) ArdanEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
